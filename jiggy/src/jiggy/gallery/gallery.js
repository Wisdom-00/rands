...
const Gallery = () => {
    ...
    // Intersection Observer for adding the 'visible' class
    useEffect(() => {
    ...
    return (
        <div className="container-fluid gallery" ref={sectionRef}>
            <h3 className='galh'><i>VISUALS</i></h3>
            <div className='row'>
            ...
            <h3 className='galh'><i>IMAGES</i></h3>
            <div className="row">
